...
def test_string_input():
    ...
    with pytest.raises(TypeError, match=matcher):
        _f = sin("test")  # type: ignore[reportArgumentType]
    with pytest.raises(TypeError, match=matcher):
        _f = cos("test")  # type: ignore[reportArgumentType]
    with pytest.raises(TypeError, match=matcher):
        _f = tan("test")  # type: ignore[reportArgumentType]
    with pytest.raises(TypeError, match=matcher):
        _f = sinh("test")  # type: ignore[reportArgumentType]
    with pytest.raises(TypeError, match=matcher):
        _f = cosh("test")  # type: ignore[reportArgumentType]
    with pytest.raises(TypeError, match=matcher):
        _f = tanh("test")  # type: ignore[reportArgumentType]
    with pytest.raises(TypeError, match=matcher):
        _f = arcsin("test")  # type: ignore[reportArgumentType]
    with pytest.raises(TypeError, match=matcher):
        _f = arccos("test")  # type: ignore[reportArgumentType]
    with pytest.raises(TypeError, match=matcher):
        _f = arctan("test")  # type: ignore[reportArgumentType]
    with pytest.raises(TypeError, match=matcher):
        _f = sqrt("test")  # type: ignore[reportArgumentType]
    with pytest.raises(TypeError, match=matcher):
        _f = sigmoid("test")  # type: ignore[reportArgumentType]
    with pytest.raises(TypeError, match=matcher):
        _f = log("test")  # type: ignore[reportArgumentType]
    with pytest.raises(TypeError, match=matcher):
        _f = exp("test")  # type: ignore[reportArgumentType]
