...
def test_basic():
    ...
    x1_, x1__ = cast(Tuple[NDArray,NDArray],gd.trace(poly, 2, return_second_deriv=True))
    assert x1_[0][0] == pytest.approx(64)
    assert x1__[0][0] == pytest.approx(96)
    x2_, x2__ = cast(Tuple[NDArray,NDArray],gd.trace(trig, np.pi, return_second_deriv=True))
    ...
    with pytest.raises(
        ...
        x1_, x1__ = cast(Tuple[NDArray,NDArray],
    ...
    with pytest.raises(
        ...
        x1_, x1__ = cast(Tuple[NDArray,NDArray],gd.trace(
            trig, non_scalar, return_second_deriv=True, mode=Mode.FORWARD
        ))
    x3_, x3__ = cast(Tuple[NDArray,NDArray],
...
def test_multiple_inputs():
    ...
    x1_, x1__ = cast(Tuple[NDArray,NDArray],gd.trace(f1, seed1, return_second_deriv=True))
    ...
    x2_, x2__ = cast(Tuple[NDArray,NDArray],gd.trace(trig, seed2, return_second_deriv=True))
