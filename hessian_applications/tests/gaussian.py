...
import numpy as np
from hessian_applications.exponential_families.exponential_family import ExponentialFamily, \
    BoxedContinuous, one_gaussian_base_measure
...
def create_oned_gaussian(known_variance: Optional[float]) -> ExponentialFamily:
    ...
    if known_variance is None:
        return ExponentialFamily(num_etas=2, num_xs=1,
    ...
    return ExponentialFamily(num_etas=1, num_xs=1,
